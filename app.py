...
# --- 2. PROFESSIONAL ACADEMY STYLING (RESTORED) ---
st.markdown("""
<style>
    .stApp {
        background: #090d16;
...
# === PAGE 4: ADMIN DASHBOARD ===
    ...
    if pwd == ADMIN_PASSWORD:
        ...
        st.warning("Please enter your admin credentials in the sidebar to access registered student records.")
